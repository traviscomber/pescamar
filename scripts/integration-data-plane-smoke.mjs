...
console.log('Integration data plane smoke PASS: versioned adapter registry, cold sensor foundation parity, authenticated organization boundary, disabled write plane, route/access and deep-link contracts verified')