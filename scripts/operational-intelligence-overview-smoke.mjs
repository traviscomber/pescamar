...
assert(brief.includes("operational?'No hay acciones pendientes ahora.':'No se asume un estado sin datos.'"),'zero-signal state must distinguish observed clearance from unavailable state rather than fabricate certainty')
