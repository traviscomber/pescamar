...
console.log('Seafood AI router smoke PASS: deterministic, fast-evidence and investigative routing, evidence-minimal loading, sufficiency gate, human review and read-only boundaries verified')
