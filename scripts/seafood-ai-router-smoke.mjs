...
assert(router.includes("SEAFOOD_QUERY_ROUTER_VERSION='seafood.router.v1'"),'query router must be explicitly versioned')
...
assert(loader.includes("route.route==='investigative'"),'investigative route may expand to optional capabilities')
...
console.log('Seafood AI router smoke PASS: deterministic, fast-evidence and investigative routing, selective evidence loading, sufficiency gate, human review and read-only boundaries verified')
