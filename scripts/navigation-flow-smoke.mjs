...
check(shell.includes("aria-label={ceoView?(locale==='es'?'Dirección':'Executive'):'Trabajo diario'}")&&shell.includes('aria-label="Consulta y configuración"'),'primary executive/daily and conditional secondary navigation groups must expose explicit assistive labels')
