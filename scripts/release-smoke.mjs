...
assert(appSource.includes('<Route path="/inicio/detalle" element={<><ExecutiveDecisionBrief/><OperationalHealthPanel/><CanonicalIntelligencePanel/><CanonicalCategoryMix/><RollforwardReconciliation/><RollforwardResolutionQueue/></>}'),'detailed intelligence must remain available behind progressive disclosure')
