...
const cases=[
 ...
 {id:'en_attention',q:'What requires attention today?',route:'fast_evidence',required:['operational_intelligence','quality','orders','inventory']},
 {id:'es_priorities',q:'Prioridades de hoy',route:'fast_evidence',required:['operational_intelligence','quality','orders','inventory']},
 {id:'en_priorities',q:"Today's priorities",route:'fast_evidence',required:['operational_intelligence','quality','orders','inventory']},
 {id:'es_compare_plants',q:'Comparar plantas',route:'investigative',required:['operational_intelligence','production','quality','inventory'],forbidden:['historical_lineage']},
 {id:'en_compare_plants',q:'Compare plants',route:'investigative',required:['operational_intelligence','production','quality','inventory'],forbidden:['historical_lineage']},
 {id:'es_blocked',q:'¿Qué está bloqueado?',route:'fast_evidence',required:['operational_intelligence','quality','orders','inventory']},
