...
type CopyKey=
 ...
 |'nav.today'|'nav.operation'|'nav.commercial'|'nav.intelligence'|'nav.admin'
 |'nav.reception'|'nav.production'|'nav.process'|'nav.packing'|'nav.inventory'|'nav.cold'
 |'nav.orders'|'nav.dispatch'|'nav.settlement'|'nav.ask'|'nav.investigate'|'nav.decide'
 ...
 |'shell.operationalFlow'|'shell.commercialFlow'|'shell.intelligenceFlow'|'shell.navigation'
...
const copy:Record<Locale,Record<CopyKey,string>>={
 es:{
  ...
  'nav.today':'Hoy','nav.operation':'Operación','nav.commercial':'Comercial','nav.intelligence':'Inteligencia','nav.admin':'Administración',
  'nav.reception':'Recepción','nav.production':'Producción','nav.process':'Proceso','nav.packing':'Packing','nav.inventory':'Inventario','nav.cold':'Frío',
  'nav.orders':'Órdenes','nav.dispatch':'Despacho','nav.settlement':'Liquidación','nav.ask':'Preguntar','nav.investigate':'Investigar','nav.decide':'Decidir',
  ...
  'shell.operationalFlow':'Flujo operativo','shell.commercialFlow':'Flujo comercial','shell.intelligenceFlow':'Flujo de inteligencia','shell.navigation':'Navegación',
 ...
 en:{
  ...
  'nav.today':'Today','nav.operation':'Operations','nav.commercial':'Commercial','nav.intelligence':'Intelligence','nav.admin':'Administration',
  'nav.reception':'Reception','nav.production':'Production','nav.process':'Process','nav.packing':'Packing','nav.inventory':'Inventory','nav.cold':'Cold chain',
  'nav.orders':'Orders','nav.dispatch':'Dispatch','nav.settlement':'Settlement','nav.ask':'Ask','nav.investigate':'Investigate','nav.decide':'Decide',
  ...
  'shell.operationalFlow':'Operational flow','shell.commercialFlow':'Commercial flow','shell.intelligenceFlow':'Intelligence flow','shell.navigation':'Navigation',
