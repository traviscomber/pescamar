...
export type Plant={id:string;name:string;location:string;mode:PlantMode;products:string[];sourceStatus:'unlinked'|'linked';photoUrl?:string|null;description?:string|null;active?:boolean}

// Catálogo operacional por validar. No contiene KPI, alertas ni resultados productivos.
export const plants:Plant[]=[
  {id:'ancud',name:'Planta Ancud',location:'Ancud · Chiloé',mode:'Propia',products:['Erizo congelado'],sourceStatus:'unlinked',active:true},
  {id:'quellon',name:'Planta Quellón',location:'Quellón · Chiloé',mode:'Propia',products:['Desconche de erizo','Erizo terminado','Pulpo','Centolla','Jaiba'],sourceStatus:'unlinked',active:true},
  {id:'iquique',name:'Planta Iquique',location:'Iquique · Sotomayor',mode:'Maquila',products:['Pulpo','Erizo congelado','Erizo fresco','Palometa'],sourceStatus:'unlinked',active:true},
