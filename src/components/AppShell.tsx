...
const operationPaths=["/plantas","/recepciones","/lineas","/floor","/inventario","/frio","/proceso","/proceso-erizo","/pallets","/planificacion","/inventario-materiales","/etiquetas","/impresion-etiquetas","/estaciones","/uni"];
