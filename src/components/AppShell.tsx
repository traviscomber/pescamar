...
const workspaceTabs:Record<Exclude<Workspace,"today"|"admin">,{to:string;label:string}[]>={
 operation:[
  {to:"/recepciones",label:"Recepciones"},
  {to:"/lineas",label:"Producción"},
  {to:"/proceso-erizo",label:"Proceso erizo"},
  {to:"/floor",label:"Packing"},
