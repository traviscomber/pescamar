import {Activity,Bot,Factory,History,LayoutDashboard,LogOut,Menu,Moon,PackageCheck,Settings2,ShieldCheck,ShoppingCart,Sun,X} from "lucide-react";
...
import {isPrimaryRolePath} from "../roleExperience";
...
export function AppShell({children,onNewReception}:{children:ReactNode;onNewReception:()=>void}){
 ...
 const showFloatingReception=mayCreate&&pathname==="/"&&operator?.role!=="operations",sessionLabel=operator?`${operator.fullName} · ${t(roleKey)}`:t('shell.session');
