...
export function AppShell({children,onNewReception}:{children:ReactNode;onNewReception:()=>void}){
 ...
 const visibleAdministration=operator?administrationItems.filter(item=>canAccessPath(operator.role,item.to)):[];
