...
const workspaceTabs:Record<Exclude<Workspace,"today"|"admin">,WorkspaceTab[]>={
 ...
 intelligence:[
  ...
  {to:"/lineage",label:"Investigar",step:2},
  {to:"/rentabilidad",label:"Decidir",step:3},
 ],
};
...
export function AppShell({children,onNewReception}:{children:ReactNode;onNewReception:()=>void}){
 ...
 const tabsLabel=workspace==="operation"?"Flujo operativo":workspace==="commercial"?"Flujo comercial":workspace==="intelligence"?"Flujo de inteligencia":`Navegación de ${workspace}`;
