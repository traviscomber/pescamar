...
export function UniVisionQaBench(){
 ...
 const reviewReasons=result?[result.roi.source==='default'?'No se detectó una cavidad de bandeja con suficiente confianza':null,result.borderCandidateRatio>0.18?'La máscara todavía toca demasiado el perímetro del área útil':null,result.usableRatio<0.015?'Hay muy poco producto aislado':null,result.usableRatio>0.92?'La máscara cubre casi toda el área útil y puede estar incluyendo contenedor':null].filter(Boolean) as string[]:[]
