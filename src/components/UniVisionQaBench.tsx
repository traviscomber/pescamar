...
import {analyzeSegmentedCanvas,type UniVisionSegmentation} from '../lib/uniVisionSegmentationV4'
...
export function UniVisionQaBench(){
 ...
 return <section className="panel" aria-label="Banco QA Uni Vision">
  <div className="section-heading"><div><span className="overline teal">Validación visual asistida · scan v4</span><h2>Revisar producto con una foto</h2></div><ScanLine size={20}/></div>
