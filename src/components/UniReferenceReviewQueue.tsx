...
type Payload={ok?:boolean;references?:Reference[];reviewQueue?:{total:number;pending:number;reviewed:number;analyzedPending:number;highPriority:number;firstBatch:string[];rule:string};qualityKnowledge?:QualityKnowledge;visionQualityComparison?:VisionQualityComparison;error?:string}
