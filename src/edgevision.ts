...
export type EdgeVisionCapabilityStatus='available'|'foundation'|'planned'
...
export const edgeVisionCapabilities:readonly EdgeVisionCapability[]=[
  ...
  {id:'color',label:'Color',outcome:'Medición objetiva de color con evidencia visual.',status:'available',currentEvidence:'Uni Vision mide CIELAB sobre captura atribuida y conserva hash de evidencia.'},
  ...
  {id:'classification',label:'Clasificación',outcome:'Grade o clase sugerida con revisión humana.',status:'available',currentEvidence:'Uni Vision puede sugerir Grade A–E por referencia de planta; el operador confirma.'},
...
export const edgeVisionAdapters:readonly EdgeVisionAdapter[]=[
  {
    ...
    implementationId:organizationContext.implementationId,
    implementation:organizationContext.implementationName,
