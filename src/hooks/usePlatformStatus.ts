...
export type PlatformStatus={ok:boolean;platform:string;environment:string;persistence:{database:boolean;files:boolean};commit:string|null;checkedAt:string}
