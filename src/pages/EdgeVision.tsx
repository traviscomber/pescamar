...
const statusLabel:Record<EdgeVisionCapabilityStatus,string>={available:`Disponible en ${organizationContext.implementationName}`,foundation:'Fundación',planned:'Planificado'}
const statusClass:Record<EdgeVisionCapabilityStatus,string>={available:'success',foundation:'info',planned:'info'}

export function EdgeVision(){
 const {operator}=useAuth()
 const available=edgeVisionCapabilities.filter(item=>item.status==='available').length
