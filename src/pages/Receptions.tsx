...
export function Receptions({lots,onNew}:{lots:Lot[];onNew:()=>void}){
  ...
  const c=isEs?{
    eyebrow:'Operación',title:'Recepciones',description:'Materia prima recibida hoy y reportes de períodos anteriores cuando los necesites.',backPlant:'Volver a planta',newReception:'+ Nueva recepción',
    ...
    history:'Reportes de recepciones',recordsAvailable:'registros disponibles · solo consulta',viewHistory:'Ver reportes',records:'Registros',guideKg:'Kg guía',receivedKg:'Kg recibidos',withObs:'Con observaciones',historySearch:'Buscar lote, proveedor, guía, zona o archivo…',historySearchAria:'Buscar reportes',historyPlantCaveat:'Los reportes de períodos anteriores aún no se filtran por esta planta hasta confirmar qué nombres de planta corresponden a cada operación actual.',
    historyAria:'Reportes de Pescamar',missingDate:'Sin fecha',date:'Fecha',lot:'Lote',supplier:'Proveedor',guide:'Guía',status:'Estado',action:'Acción',void:'Anulado',reviewed:'Revisado',openCard:'Abrir ficha'
  }:{
    eyebrow:'Operations',title:'Receptions',description:'Raw material received today, with previous-period reports available when needed.',backPlant:'Back to plant',newReception:'+ New reception',
    ...
    history:'Reception reports',recordsAvailable:'records available · read only',viewHistory:'View reports',records:'Records',guideKg:'Guide kg',receivedKg:'Received kg',withObs:'With observations',historySearch:'Search lot, supplier, guide, zone or file…',historySearchAria:'Search reports',historyPlantCaveat:'Previous-period reports are not filtered by this plant until source plant names are confirmed against current plants.',
    historyAria:'Pescamar reports',missingDate:'No date',date:'Date',lot:'Lot',supplier:'Supplier',guide:'Guide',status:'Status',action:'Action',void:'Voided',reviewed:'Reviewed',openCard:'Open record'
  }
