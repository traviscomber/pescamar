...
type CalibrationSummary={captures:number;confirmed:number;accepted:number;lots:number;agreement:{matched:number;total:number;ratio:number}|null;references:Array<{plant_id:string;grade:string;count:number|string}>}
