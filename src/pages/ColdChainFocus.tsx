...
export function ColdChainFocus(){
 ...
 return <>
  <PageHeader eyebrow="Plant Execution" title="Cadena de frío" description="Estado, excepción y siguiente acción."/>
