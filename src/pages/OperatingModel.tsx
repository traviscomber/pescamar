...
const workflowFacts:WorkflowFact[]=[
 ...
 {stage:'Cadena de frío',state:'partial',automated:'Existe ingesta machine-to-machine fail-closed para sensores, con scope por ciclo/planta/estación e idempotencia; ciclos y desviaciones quedan trazados.',human:'Registrar una lectura manual sólo como fallback y revisar cualquier desviación antes de liberar producto.',next:'Conectar un gateway/sensor real, configurar el secreto fuera del código y verificar telemetría live antes de declarar automatización operacional.'},
