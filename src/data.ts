import type { ColorStandard, Lot, ProductionLine } from './types'

export const initialLots: Lot[] = [
  { id:'ER-260819-04', species:'Erizo', supplier:'Juan Rain', initials:'JR', zone:'Bahía de Ancud', gross:312, tare:8, drained:286, accepted:278, loss:10.9, gonadYield:10.4, premiumYield:72.1, temperature:4.1, status:'Clasificado', receivedAt:'10:18', evidenceCount:4 },
  { id:'LO-260819-03', species:'Loco', supplier:'María Catrilef', initials:'MC', zone:'Canal de Chacao', gross:284, tare:7, drained:256, accepted:249, loss:12.3, gonadYield:null, premiumYield:76.4, temperature:3.8, status:'Clasificado', receivedAt:'09:42', evidenceCount:4 },
  { id:'JA-260819-02', species:'Jaiba', supplier:'Alexis Paillán', initials:'AP', zone:'Quemchi', gross:365, tare:10, drained:297, accepted:287, loss:21.4, gonadYield:null, premiumYield:41.8, temperature:5.6, status:'Revisión', receivedAt:'08:57', evidenceCount:2 },
  { id:'ER-260819-01', species:'Erizo', supplier:'Cooperativa Lliuco', initials:'CL', zone:'Quinchao', gross:279, tare:6, drained:240, accepted:234, loss:16.1, gonadYield:9.9, premiumYield:63.2, temperature:4.4, status:'Alerta calibre', receivedAt:'08:15', evidenceCount:4 }
]
