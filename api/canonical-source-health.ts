...
export default async function handler(req:Request,res:Response){
  ...
  try{
    ...
    return res.status(200).json({
      ok:true,
      schemaVersion:'seafood.canonical.source-health.v1',
