...
const gdst2EventMappingByType:Record<SeafoodEventType,Gdst2EventMapping>={
  ...
  packing:{seafoodEventType:'packing',cte:null,epcisType:null,action:null,bizStep:null,state:'supporting_evidence',condition:'El packing demuestra acondicionamiento físico y puede aportar producto, peso y especificación; no se convierte automáticamente en CTE hasta definir el perfil EPCIS/GDST aplicable.',blockers:[]},
  pallet:{seafoodEventType:'pallet',cte:null,epcisType:null,action:null,bizStep:null,state:'supporting_evidence',condition:'La conformación de pallet y un eventual SSCC son evidencia de agregación. No se emite AggregationEvent hasta implementar y validar ese perfil explícitamente.',blockers:[]},
  cold:{seafoodEventType:'cold',cte:null,epcisType:null,action:null,bizStep:null,state:'supporting_evidence',condition:'Frío aporta evidencia de condición, ubicación y tiempo; no constituye por sí solo un CTE GDST.',blockers:[]},
...
export const gdst2CapabilityProfile={
  ...
  capabilities:[
    ...
    {id:'event-profile-mapping',state:'foundation' as const,evidence:'Receiving, transformation y shipping tienen mapping candidato explícito; packing, pallet y frío permanecen como evidencia de soporte hasta definir perfiles EPCIS/GDST aplicables.'},
    ...
    {id:'epcis-jsonld-serialization',state:'foundation' as const,evidence:'Existe serializer EPCIS 2.0 JSON-LD read-only y fail-closed, cubierto por CI. External export permanece OFF y no se emiten eventos parciales ni identidades derivadas.'},
